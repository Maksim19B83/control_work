...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        if (confirm.equals("y")) {
            ...
            while (remainder > 0){
                ...
                System.out.printf("Название %d-й игрушки: " ,tempIdToy);
                String testNameToy = scanner.nextLine();
                System.out.print("Задайте вероятность выбора данной игрушки (от 1 до 100): ");
            ...
            System.out.println();
            System.out.println("************************************************");
            System.out.println("Создана база игрушек для розыгрыша:");
            ...
            try {
                ...
                pw.close();
                System.out.println("************************************************");
                System.out.println("Итоги розыгрыша сохранены в файле update.txt");
            } catch (IOException e) {
    ...
    static int CheckPercent(int percent, int remPercent){
        if ((remPercent - percent) < 0 ){
            ...
            System.out.printf("Оставшийся процент вероятности для распределения - %d значение исправлено автоматически.", newPercent);
            return newPercent;
        }
        return percent;
    }
